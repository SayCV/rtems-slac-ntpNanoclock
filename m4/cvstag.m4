#
# TILLAC_CVSTAG([$Name: ntpNanoclock_R1_0 $], [pattern])
#
# Strip $Name: ntpNanoclock_R1_0 $ from first argument extracting
...
#
# AC_INIT(package, TILLAC_CVSTAG([$Name: ntpNanoclock_R1_0 $]))
#
...
# and using the macro:
#
# AC_INIT(package, TILLAC_CVSTAG([$Name: ntpNanoclock_R1_0 $],'Release_'))
#
